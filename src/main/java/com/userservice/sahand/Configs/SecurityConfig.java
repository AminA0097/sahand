    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .authorizeHttpRequests(authReq -> authReq
                        ...
                        .requestMatchers(HttpMethod.POST, "/msg/test").permitAll()
                        ...
                        .requestMatchers(HttpMethod.POST, "profile/getAll").permitAll()
                        .requestMatchers(HttpMethod.POST, "profile/del").permitAll()
                        .requestMatchers(HttpMethod.POST, "/auth/verifyToken").permitAll()
